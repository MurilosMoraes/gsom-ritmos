  ...
  private showExpired(): void {
    ...
    overlay.innerHTML = `
      <div class="demo-expired-card">
        ...
        <p>Voce acabou de sentir como e ter acompanhamento profissional de verdade. Sao <strong style="color:#fff;">50 ritmos</strong> que seguram sua musica do comeco ao fim — vaneira, sertanejo, rock, forro, gospel e muito mais.</p>
        <p style="color:rgba(255,255,255,0.4);font-size:0.82rem;margin-bottom:1.5rem;">Cadastre gratis. Sem cartao. Acesso completo por 48h.</p>
        ...
        <div style="margin-top:1.5rem;padding-top:1rem;border-top:1px solid rgba(255,255,255,0.06);">
          <a href="https://chat.whatsapp.com/CnTLQogcUNFEVeFkyKzkyK" target="_blank" style="display:inline-flex;align-items:center;gap:0.4rem;color:rgba(0,230,140,0.7);font-size:0.75rem;text-decoration:none;">
            ...
            Duvidas? Fale com a gente no WhatsApp
          </a>
        </div>
      </div>
    `;
